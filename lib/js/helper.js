...
var passDisp = document.getElementById('password');
var xters =  "!@#$%&?+*";
    ...
    var sentence = input.value;          
      ...
      const max = words.length - 1,
            ...
            for(var i=0; i<words.length;i++){
               ...
               password.push( words[i]+helper.shuffle(xters).substr(0,1)+':');
                
            }
  
            // console.log(password)
            passDisp.value = password.join(" ")+" "+Math.floor(Math.random()*(50-10+1)+10)+':'
